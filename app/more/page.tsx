...
import { Card, SectionLabel } from "@/components/ui/FamilyCard";
...
const menuItems = [
  { label: "月度回顾", desc: "每月记录一次", icon: Calendar, href: "/more/review" },
  { label: "设置", desc: "账户与偏好", icon: Settings, href: "/more/settings" },
  { label: "关于 Family OS", desc: "版本 Alpha 0.3", icon: Info, href: "/more/about" },
];
